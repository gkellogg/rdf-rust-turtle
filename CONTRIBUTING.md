...
* create or respond to an issue on the [Github Repository](http://github.com/ruby-rdf/rdf-rust-turtle/issues)
* Fork and clone the repo:
  `git clone git@github.com:your-username/rdf-rust-turtle.git`
* Install bundle:
  `bundle install`
...
[pr]:      https://github.com/ruby-rdf/rdf-rust-turtle/compare/
